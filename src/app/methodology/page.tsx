  ...
  return (
    <main className="page-shell">
      ...
      <section className="mt-6 card p-6">
        ...
        <h2 className="mt-3 text-2xl font-semibold">5.1 十四个逻辑数据层</h2>
        <p className="mt-3 max-w-3xl text-sm leading-7 text-[var(--muted)]">
      ...
      <section className="mt-6 card p-6">
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-2">
          {[
            "当前阶段：v0.9 beta / regions + region_boundaries + region_indicators + region_observations + region_sources 区域层准备。",
