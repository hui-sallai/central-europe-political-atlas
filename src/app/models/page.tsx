  ...
  return (
    <main className="page-shell">
      <header className="max-w-4xl border-b border-[var(--line)] pb-8">
        ...
        <p className="mt-5 text-base leading-8 text-[var(--muted)]">在同一入口运行透明综合指标与 2015–2025 年度面板估计，或切换到十国横向对比——正式比较只在同一版本、同一单位、同一输入年份下进行。VAR 与 Bayesian 因频率不足保持 blocked。</p>
      ...
      <ModelsPageTabs
        runAnalysis={<AnalysisWorkbench countries={researchCountries} cards={modelCards} outputs={modelOutputs} />}
        compareCountries={
