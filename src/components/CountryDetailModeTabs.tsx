        ...
        <section className="mt-4 card p-6">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            {[
              ...
              ["NUTS code 数量", String(hungaryNuts3ValidationManifestSummary.nuts_code_count)],
              ["region_id candidate 数量", String(hungaryNuts3ValidationManifestSummary.region_id_candidate_count)],
              ["明细记录数量", String(hungaryNuts3ValidationManifestSummary.detail_record_count)],
              ["匹配记录数量", String(hungaryNuts3ValidationManifestSummary.matched_region_count)],
              ["缺失匹配", String(hungaryNuts3ValidationManifestSummary.unmatched_region_count)],
