...
export const releaseChangelog = [
  ...
  ["v1.42 Seasonal Controls & Dynamic Diagnostic Adequacy", "Added a second pre-registered formal baseline with a constant and 11 month-of-year controls while preserving the original constant-only baseline.", "Made h=12 the primary residual diagnostic, added horizon-specific 6/12/18/24 dynamic-response gates, residual seasonality summaries and a full legal-lag diagnostic grid without replacing the BIC baseline.", "HICP remains non-seasonally-adjusted source data; model controls are not official seasonal adjustment. SVAR, Local Projections, Bayesian VAR and confidence intervals remain unavailable."],
  ["v1.43 Seasonality-Aware Stationarity & Structural-Break Diagnostics", "Aligned baseline v1 with constant-only ADF and baseline v2 with ADF plus 11 monthly deterministic terms; no profile selects a test after seeing the result.", "Added source-adjustment-aware seasonality audit, ACF/PACF and lag-12 persistence diagnostics, plus honest HEGY and Zivot-Andrews registry boundaries.", "Seasonal controls do not prove absence of seasonal unit roots or structural breaks; all v1.42 stability, residual and horizon gates remain unchanged."],
  ["v1.44 Finite-Sample Stationarity Calibration & Break Robustness", "Calibrated the exact seasonal-dummy ADF production design with nine finite-sample Monte Carlo nodes and 50,000 replications per node; baseline v2 now uses the calibrated decision while retaining the v1.43 MacKinnon-c historical reference.", "Added decision-change provenance, HEGY readiness, descriptive ACF/PACF bands and a strict separation between historical candidate periods and statistically estimated breaks.", "Zivot-Andrews remains registry_only because production/reference alignment is incomplete; no stability, residual, orthogonalization or dynamic-response gate was relaxed."],
  ["v1.5 Macro Drivers & Shock Identification Foundation", "Added a separate monthly macro-driver layer for policy rates, long-term yields, bilateral/effective exchange rates, HICP Energy and external commodity prices with official-source acquisition manifests.", "Registered observed drivers, shock candidates, blocked future shocks and Local Projections readiness without estimating causal responses.", "Frozen v1.44 VAR baselines and gates remain unchanged; identified_shock count is zero."],
  ["v1.51 Macro-Driver Temporal & Scope Integrity", "Enforced exact calendar lags, separated transformation warm-up from source missingness, and blocked policy changes across regime or instrument transitions.", "Registered shared-series identities and dated country applicability so common ECB, EUR/USD and commodity drivers cannot be treated as independent country shocks.", "Economic role and identification status are now orthogonal; identified shock and causal LP counts remain zero."],
  ["v1.6 ECB Monetary Policy Identification & LP Readiness", "Acquired the official ECB EA-MPD and EA-EMPD workbooks, recorded checksums and workbook schemas, and published derived event-window observations without redistributing the raw Excel files.", "Added event-type separation, CET/CEST-aware timestamps, EA-MPD/EA-EMPD deduplication, factor semantics, information-effect audit, monthly aggregation and dated country applicability.", "The published OIS series remain external innovation proxies because central-bank information effects are not separated; identified shock and causal LP counts remain zero, and Local Projections remain registry-only."],
  ["v1.61 Information-Effect Separation & Monetary Shock Calibration", "Audited the published Jarociński–Karadi method, official replication-project metadata, and the OIS_3M/STOXX50 combined-window input mapping.", "Activated a deterministic poor-man sign diagnostic and explicit method, sample, specification, regime and validation registries.", "Structural event/monthly shocks are withheld because exact replication and estimand alignment are blocked; identified shock and causal LP counts remain zero."],
  ["v1.62 Author-Reference Shock Replication & Identification Validation", "Pinned the author-maintained ECB update repository and reproduced PC1, poor-man, median-rotation and monthly outputs at published precision.", "Activated two representative JK median identified shocks with JavaScript/Python cross-validation.", "Local Projections, SVAR and BVAR remain registry-only; no impulse responses are published."],
  ["v1.7 Local Projections & ECB Spillover Transmission", "Activated single-country joint MP/CBI lag-augmented Local Projections for combinations passing identification, applicability, common-horizon sample and N≥96 gates.", "Cross-validated production coefficients, HC1 standard errors and horizon indexing against NumPy/SciPy/statsmodels, with pointwise 90% and 95% intervals.", "The v1.62 JK shock construction remains frozen; panel LP, state dependence, SVAR and Bayesian VAR remain unavailable."],
  ["v1.71 Local Projection Inference & Robustness Hardening", "Corrected lag-augmentation metadata without changing any baseline coefficient or standard error, and activated 95% plug-in sup-t simultaneous path bands from joint cross-horizon HC1 covariance.", "Added fixed-lag, predetermined-control, shock-support, influence, conditioning and cross-country comparability diagnostics with comparison-common samples.", "Significance bands and formal cross-country heterogeneity tests remain registry-only; panel and state-dependent LP remain unavailable."],
  ["v1.72 Finite-Sample Bias & Shock-Support Robustness", "Preserved the v1.71 formal baseline and audited effective shock support, all nonzero-month deletions and frozen-event contribution deletions.", "Added 386 finite-sample designs, 8 key designs with 10000 repetitions each, full-model joint covariance QA and sup-t seed sensitivity.", "The Fed accessible ZIP has no replication code; current-specification bias correction remains registry-only, without invented corrected intervals."],
] as const;
