...
export const researchDataLayerFiles = [
  ...
  { id: "region_boundaries", label: "region_boundaries", description: "v0.12 区域边界来源表；hu_nuts3_gisco_2024 已进入沙盒验证与基础拓扑 QA，并继续保持 not_ready_for_display。" },
  ...
  { id: "region_quality_checks", label: "region_quality_checks", description: "v0.13 区域数据质量验收表；在既有 Hungary NUTS3 sandbox QA 中增加视觉 QA 字段，正式展示状态保持 false。" },
  ...
  { id: "map_layers", label: "map_layers", description: "v0.13 地图图层注册表；hu_nuts3_boundary_pilot 仅进入内部视觉 QA，is_ready_for_display=false。" },
