...
export const researchDataLayerFiles = [
  ...
  { id: "regions", label: "regions", description: "v0.21 区域元数据表；匈牙利 NUTS3 已记录最终主键、许可与权威拓扑判定。" },
  { id: "region_boundaries", label: "region_boundaries", description: "v0.21 区域边界来源表；hu_nuts3_gisco_2024 记录 authoritative_topology_validated 并继续保持 not_ready_for_display。" },
  ...
  { id: "region_quality_checks", label: "region_quality_checks", description: "v0.21 区域数据质量验收表；记录 Hungary authoritative topology validation decision summary，正式展示状态保持 false。" },
  ...
  { id: "map_layers", label: "map_layers", description: "v0.21 地图图层注册表；hu_nuts3_boundary_pilot 同步权威拓扑判定，is_ready_for_display=false。" },
