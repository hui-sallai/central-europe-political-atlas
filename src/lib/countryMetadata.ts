...
export const researchDataLayerFiles = [
  ...
  { id: "region_quality_checks", label: "region_quality_checks", description: "v0.12 区域数据质量验收表；增加 Hungary NUTS3 sandbox QA 摘要，同步要素、代码、CRS、几何、拓扑、主键和展示状态。" },
  ...
  { id: "map_layers", label: "map_layers", description: "v0.12 地图图层注册表；hu_nuts3_boundary_pilot 继续保持 is_ready_for_display=false。" },
