...
export const researchDataLayerFiles = [
  ...
  { id: "regions", label: "regions", description: "v0.19 区域元数据表；匈牙利 NUTS3 同步 final region-id match decision。" },
  { id: "region_boundaries", label: "region_boundaries", description: "v0.20 区域边界来源表；hu_nuts3_gisco_2024 记录 GISCO 非商业研究展示许可判定并继续保持 not_ready_for_display。" },
  ...
  { id: "region_quality_checks", label: "region_quality_checks", description: "v0.20 区域数据质量验收表；记录 Hungary GISCO license verification decision summary，正式展示状态保持 false。" },
  { id: "region_sources", label: "region_sources", description: "v0.20 区域来源字典；锁定 GISCO NUTS 2024 Level 3 GeoJSON，并记录公开非商业研究展示许可与署名要求。" },
  { id: "project_locations", label: "project_locations", description: "v0.11 继续保留对华项目地区定位表；不启用真实项目点位图层。" },
  { id: "map_layers", label: "map_layers", description: "v0.20 地图图层注册表；hu_nuts3_boundary_pilot 同步 GISCO 许可判定，is_ready_for_display=false。" },
