...
export const researchDataLayerFiles = [
  ...
  { id: "region_quality_checks", label: "region_quality_checks", description: "v0.13.1 区域数据质量验收表；记录 Hungary NUTS3 视觉 QA 结果，正式展示状态保持 false。" },
  ...
  { id: "map_layers", label: "map_layers", description: "v0.13.1 地图图层注册表；hu_nuts3_boundary_pilot 仅记录内部视觉 QA 结果，is_ready_for_display=false。" },
