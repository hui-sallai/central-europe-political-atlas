...
export const researchDataLayerFiles = [
  ...
  { id: "region_indicators", label: "region_indicators", description: "独立于国家级 indicators 的区域指标字典；P0 与 P1 优先级和层级政策明确。" },
  { id: "region_observations", label: "region_observations", description: "v0.86 接入欧盟九国 2021–2024 P0 区域事实；缺失位置保留 null，不下推国家值。" },
