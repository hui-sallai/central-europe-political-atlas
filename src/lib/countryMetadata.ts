...
export const researchDataLayerFiles = [
  ...
  { id: "regions", label: "regions", description: "v0.17 区域元数据表；匈牙利 NUTS3 同步 validation manifest 与20条待最终核验记录摘要。" },
  { id: "region_boundaries", label: "region_boundaries", description: "v0.17 区域边界来源表；hu_nuts3_gisco_2024 记录 manifest 状态并继续保持 not_ready_for_display。" },
  ...
  { id: "region_quality_checks", label: "region_quality_checks", description: "v0.17 区域数据质量验收表；记录 Hungary NUTS3 validation manifest summary，正式展示状态保持 false。" },
  ...
  { id: "map_layers", label: "map_layers", description: "v0.17 地图图层注册表；hu_nuts3_boundary_pilot 同步 manifest 状态，is_ready_for_display=false。" },
