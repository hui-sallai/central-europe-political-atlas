...
export const researchDataLayerFiles = [
  ...
  { id: "region_boundaries", label: "region_boundaries", description: "v0.11 区域边界来源表；hu_nuts3_gisco_2024 已标记 sandbox_downloaded / sandbox_filtered / not_ready_for_display。" },
  ...
  { id: "region_quality_checks", label: "region_quality_checks", description: "v0.11 区域数据质量验收表；同步 Hungary NUTS3 沙盒的下载、过滤、CRS、许可、拓扑、主键和展示准备状态。" },
  { id: "region_sources", label: "region_sources", description: "v0.11 区域来源字典；锁定 GISCO NUTS 2024 Level 3 GeoJSON，同时保留待确认的许可状态。" },
  { id: "project_locations", label: "project_locations", description: "v0.11 继续保留对华项目地区定位表；不启用真实项目点位图层。" },
  { id: "map_layers", label: "map_layers", description: "v0.11 地图图层注册表；hu_nuts3_boundary_pilot 继续保持 is_ready_for_display=false。" },
