...
export const researchDataLayerFiles = [
  ...
  { id: "region_quality_checks", label: "region_quality_checks", description: "v0.14 区域数据质量验收表；记录 Hungary NUTS3 展示准入闸门，正式展示状态保持 false。" },
  ...
  { id: "map_layers", label: "map_layers", description: "v0.14 地图图层注册表；hu_nuts3_boundary_pilot 记录 readiness gate，is_ready_for_display=false。" },
