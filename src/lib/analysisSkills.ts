...
export const futureAnalysisSkills: AnalysisSkill[] = [
  {
    ...
    description: "跨国家与跨年份面板估计接口；当前仅登记数据要求和诊断结构。",
    required_data: ["balanced_or_documented_unbalanced_panel", "stable_indicator_definitions"],
    ...
    supported_frequency: ["annual", "quarterly"],
    ...
    limitations: ["不在 v1.1 运行估计。", "没有满足口径与样本量要求时不得生成系数。"],
    citation: registryCitation,
  },
  {
    skill_id: "var_svar",
    ...
    limitations: ["不在 v1.1 运行。", "年度五年序列不足以支持 VAR。"],
    citation: registryCitation,
  },
  {
  ...
  },
  {
    ...
    description: "贸易、项目与供应链关系网络分析接口；当前不生成中心性或依赖分数。",
    ...
    supported_spatial_level: ["country", "region", "project"],
    supported_frequency: ["annual", "event"],
    calculation_mode: "registry_only",
    ...
    limitations: ["不在 v1.1 运行。", "项目样本库不等于完整经济网络。"],
    citation: registryCitation,
  },
  {
    ...
    limitations: ["不在 v1.1 运行。", "不得把先验设定隐藏为客观事实。"],
    citation: registryCitation,
  },
  {
