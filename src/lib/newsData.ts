...
export const weeklyNewsItems: WeeklyNewsItem[] = [
  ...
  },
  {
    ...
    countrySlug: "poland",
    countryZh: "波兰",
    title: "样例新闻：政府继续强调安全、基础设施和欧盟资金议题",
    topic: "欧盟",
  ...
  },
  {
    ...
    countrySlug: "czechia",
    countryZh: "捷克",
    title: "样例新闻：产业竞争力、能源供应与政府经济政策受到关注",
    topic: "能源",
  ...
  },
  {
    ...
    countryZh: "斯洛伐克",
    title: "样例新闻：政府政策、汽车产业链和区域发展是本周重点",
    topic: "区域",
    summary: "当前为样例文本，主要用于页面结构验证。",
    sourceLabel: "待接入来源",
    language: "sk / en / zh",
    weekOf: "2026-06-01",
    dataStatus: "sample",
  },
  {
    ...
    countrySlug: "germany",
    countryZh: "德国",
    title: "样例新闻：产业链、能源转型和对华贸易议题是本周观察入口",
    topic: "经济",
    summary: "当前为结构占位。正式版将接入德语新闻、官方公告和人工审核摘要。",
    sourceLabel: "待接入来源",
    language: "de / en / zh",
    weekOf: "2026-06-01",
    dataStatus: "sample",
  },
  {
    ...
    countrySlug: "romania",
    countryZh: "罗马尼亚",
    title: "样例新闻：黑海、能源、港口和制造业政策进入周报观察框架",
    topic: "能源",
    summary: "当前为结构占位。正式版将接入罗马尼亚语新闻、官方公告和中文摘要。",
    sourceLabel: "待接入来源",
    language: "ro / en / zh",
    weekOf: "2026-06-01",
    dataStatus: "sample",
  },
  {
    ...
    countryZh: "斯洛文尼亚",
    title: "样例新闻：港口、物流和欧盟内部产业联系作为本周观察入口",
    topic: "区域",
    summary: "当前为结构占位。正式版将接入斯洛文尼亚语新闻和官方来源。",
    sourceLabel: "待接入来源",
    language: "sl / en / zh",
    weekOf: "2026-06-01",
    dataStatus: "sample",
  },
  {
    ...
    countrySlug: "serbia",
    countryZh: "塞尔维亚",
    title: "样例新闻：基础设施、矿业和对华经贸项目成为周报观察入口",
    topic: "对华经贸",
    summary: "当前为结构占位。正式版需特别标注项目来源、融资状态和政治口径。",
    sourceLabel: "待接入来源",
    language: "sr / en / zh",
    weekOf: "2026-06-01",
    dataStatus: "sample",
  },
  {
    ...
    countrySlug: "austria",
    countryZh: "奥地利",
    title: "样例新闻：欧盟政策、制造业和区域物流是本周观察入口",
    topic: "欧盟",
    summary: "当前为结构占位。正式版将接入奥地利德语新闻和官方统计资料。",
    sourceLabel: "待接入来源",
    language: "de / en / zh",
    weekOf: "2026-06-01",
    dataStatus: "sample",
  },
  {
    ...
    countrySlug: "croatia",
    countryZh: "克罗地亚",
    title: "样例新闻：亚得里亚港口、旅游和基础设施项目进入周报观察框架",
    topic: "区域",
    summary: "当前为结构占位。正式版将接入克罗地亚语新闻和官方公告。",
    sourceLabel: "待接入来源",
    language: "hr / en / zh",
    weekOf: "2026-06-01",
    dataStatus: "sample",
