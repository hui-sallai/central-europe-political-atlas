...
export const sourceDictionaryRows: SourceDictionaryRecord[] = [
  ...
  { sourceId: "national_statistics", nameZh: "各国统计局", nameEn: "National statistical offices", sourceType: "各国统计局", coverage: "十国", indicatorCoverage: "人口、国民账户、价格、劳动力、产业", url: "https://hy-central-europe-analysis.org/data/", reliabilityLevel: "A", sourceStatus: "official", updateFrequency: "按国家发布节奏", canBeOfficialData: true, canBeEventBasis: false, supplementalOnly: false, excludedFromAnalysis: false, lastCheckedAt, note: "国家官方统计机构；用于正式观测值，正式版逐国替换为具体统计局链接。" },
  ...
  { sourceId: "official_government", nameZh: "官方政府部门", nameEn: "Official government departments", sourceType: "官方政府部门", coverage: "十国", indicatorCoverage: "政府结构、政策事件、项目公告", url: "https://hy-central-europe-analysis.org/methodology/", reliabilityLevel: "A", sourceStatus: "official", updateFrequency: "按公告更新", canBeOfficialData: true, canBeEventBasis: true, supplementalOnly: false, excludedFromAnalysis: false, lastCheckedAt, note: "政府公告、部委材料和正式政策文件可作为正式数据或事件依据。" },
  { sourceId: "electoral_commissions", nameZh: "选举机构", nameEn: "Electoral commissions", sourceType: "选举机构", coverage: "十国", indicatorCoverage: "选举结果、政党、区域投票", url: "https://hy-central-europe-analysis.org/methodology/", reliabilityLevel: "A", sourceStatus: "pending", updateFrequency: "按选举周期", canBeOfficialData: true, canBeEventBasis: true, supplementalOnly: false, excludedFromAnalysis: false, lastCheckedAt, note: "官方选举结果可作为正式数据和事件依据；当前区域选举数据待接入。" },
  ...
  { sourceId: "official_annual_reports", nameZh: "官方年报", nameEn: "Official annual reports", sourceType: "官方年报", coverage: "机构 / 企业 / 政府", indicatorCoverage: "项目主体、金额、股权、产能", url: "https://hy-central-europe-analysis.org/data/", reliabilityLevel: "B", sourceStatus: "manual", updateFrequency: "年度", canBeOfficialData: true, canBeEventBasis: true, supplementalOnly: false, excludedFromAnalysis: false, lastCheckedAt, note: "可作为项目金额、主体、股权和产能核验来源。" },
  { sourceId: "company_announcements", nameZh: "企业公告", nameEn: "Company announcements", sourceType: "企业公告", coverage: "项目主体", indicatorCoverage: "对华项目金额、主体、时间线", url: "https://hy-central-europe-analysis.org/data/", reliabilityLevel: "B", sourceStatus: "manual", updateFrequency: "按公告更新", canBeOfficialData: true, canBeEventBasis: true, supplementalOnly: false, excludedFromAnalysis: false, lastCheckedAt, note: "可作为项目和企业行为依据；关键金额进入分析前需与官方或年报交叉核验。" },
  { sourceId: "local_media", nameZh: "地方媒体", nameEn: "Local media", sourceType: "地方媒体", coverage: "国家 / 地方", indicatorCoverage: "项目线索、地方事件", url: "https://hy-central-europe-analysis.org/news/", reliabilityLevel: "C", sourceStatus: "manual", updateFrequency: "不定期", canBeOfficialData: false, canBeEventBasis: true, supplementalOnly: true, excludedFromAnalysis: false, lastCheckedAt, note: "可作为事件线索和地方补充，不单独进入正式数据。" },
  { sourceId: "industry_sites", nameZh: "行业网站", nameEn: "Industry websites", sourceType: "行业网站", coverage: "行业 / 企业", indicatorCoverage: "产业链、汽车、能源、物流项目", url: "https://hy-central-europe-analysis.org/data/", reliabilityLevel: "C", sourceStatus: "manual", updateFrequency: "不定期", canBeOfficialData: false, canBeEventBasis: true, supplementalOnly: true, excludedFromAnalysis: false, lastCheckedAt, note: "可作为行业事件和项目线索，进入正式分析前需更高等级来源复核。" },
  { sourceId: "manual_sources", nameZh: "人工整理来源", nameEn: "Manually curated sources", sourceType: "人工整理来源", coverage: "平台内部", indicatorCoverage: "摘要、翻译、字段整理", url: "https://hy-central-europe-analysis.org/methodology/", reliabilityLevel: "C", sourceStatus: "manual", updateFrequency: "随数据维护", canBeOfficialData: false, canBeEventBasis: true, supplementalOnly: true, excludedFromAnalysis: false, lastCheckedAt, note: "必须回链到原始来源，不能单独作为正式依据。" },
