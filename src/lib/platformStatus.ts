...
export const platformStatus = {
  ...
  modelLayer: "4 transparent composite indicators; annual panel with cluster-t inference; bilateral trade network active; monthly high-frequency layer; descriptive event window analysis",
