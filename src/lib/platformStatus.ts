...
export const platformStatus = {
  ...
  modelLayer: "4 transparent composite indicators; annual panel; bilateral trade network; monthly high-frequency and macro-driver layers; reduced-form VAR; LP/SVAR registry-only",
