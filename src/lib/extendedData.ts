...
export const chinaProjectRecords: ChinaProjectRecord[] = [
  {
    ...
    relatedIndicatorIds: ["exports_goods_services", "imports_goods_services", "trade_balance"],
    exposureDimensions: ["物流暴露", "贸易暴露"],
    relatedEventIds: [],
    status: "manual",
  ...
  },
  {
    ...
    relatedIndicatorIds: ["fdi_inflow", "manufacturing_share_gdp", "automotive_export_share"],
  ...
  },
  {
    ...
    relatedIndicatorIds: ["fdi_inflow", "manufacturing_share_gdp"],
    exposureDimensions: ["企业存在", "政策争议"],
    relatedEventIds: ["pl-2024-04-23-nuctech-fsr-inspection"],
    status: "manual",
  ...
  },
  {
    ...
    relatedIndicatorIds: ["fdi_inflow", "manufacturing_share_gdp", "automotive_export_share", "battery_investment"],
    exposureDimensions: ["投资暴露", "供应链暴露"],
  ...
  },
  {
    ...
    relatedIndicatorIds: ["fdi_inflow", "exports_goods_services", "imports_goods_services", "trade_balance"],
    exposureDimensions: ["投资暴露", "物流暴露", "金融暴露"],
    relatedEventIds: [],
  ...
  },
  {
    ...
    relatedIndicatorIds: ["fdi_inflow"],
    exposureDimensions: ["投资暴露", "企业存在"],
    relatedEventIds: [],
    status: "manual",
  ...
  },
  {
    ...
    relatedIndicatorIds: ["fdi_inflow", "battery_investment"],
