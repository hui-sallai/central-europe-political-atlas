...
export const chinaProjectRecords: ChinaProjectRecord[] = [
  ...
  },
  {
    ...
    exposureIndexEligible: false,
    status: "manual",
    note: "项目具有安全、采购和欧盟监管维度；不以金额计入暴露指数，先作为事件与风险标签样本。",
  },
  {
    ...
    exposureIndexEligible: true,
    status: "manual",
    note: "金额和地点来自企业公告；进入暴露指数前仍需补贴、产能、雇佣和供应链依赖字段。",
  },
  {
    ...
    exposureIndexEligible: false,
    status: "manual",
    note: "项目规模较大但金额未在来源中明确披露；暂不进入暴露指数，待补投资额、产能和补贴条件。",
  },
  {
    ...
    exposureIndexEligible: true,
    note: "保留原币种金额；进入指数前需补贷款结构、承包比例、工期和现金流字段。",
  },
  {
  ...
  },
  {
    ...
    exposureIndexEligible: true,
    status: "manual",
    note: "斯洛伐克最重要的中国电池链条项目入口；进入指数前需补股权、补贴、产能、投产年份和地方审批状态。",
  },
  {
