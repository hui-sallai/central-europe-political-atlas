...
if (!["reference", "build", "validate", "composition", "robustness-validate", "path-build", "path-reference", "path-validate", "path-simulate"].includes(task)) throw new Error("Unknown panel LP task");
