...
const identifiedShockFiles = [
  "ecb_monetary_event_data_acquisition_manifest.json",
  "ea_mpd_acquisition_manifest.json",
  "ea_empd_acquisition_manifest.json",
  "ea_mpd_workbook_schema.json",
  "ea_empd_workbook_schema.json",
  "monetary_policy_event_observations.json",
  "ecb_policy_factor_registry.json",
  "monetary_policy_information_effect_registry.json",
  "ecb_event_dataset_overlap_registry.json",
  "ecb_monetary_policy_monthly_series.json",
  "shock_applicability_registry.json",
  ...
  "identification_specification_registry.json",
  "jk_event_level_shocks.json",
  "ecb_pure_monetary_policy_shock_monthly.json",
  "ecb_central_bank_information_shock_monthly.json",
  "information_effect_separation_validation.json",
...
writeJson("release_manifest.json", {
  ...
  scenario_versions: scenarioDefinitions.map((scenario) => ({
    scenario_id: scenario.scenario_id,
    formula_version: SCENARIO_FORMULA_VERSION,
    reference_model_id: scenario.reference_model_id,
    adjusted_indicator_id: scenario.adjusted_indicator_id,
    shock_min: scenario.shock_min,
    shock_max: scenario.shock_max,
